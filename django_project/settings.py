...
from hyperp import mkdir, to_int, read


env = loads(read(".env.json", "{}"))

# Build paths inside the project like this: BASE_DIR / 'subdir'.
BASE_DIR = Path(__file__).resolve().parent.parent
DATA_DIR = env.get("DATA_DIR", str(BASE_DIR) + "/data")
mkdir(DATA_DIR)
...
SECRET_KEY = env.get("SECRET_KEY", "hopefully_you_only_run_this_locally")

WEB_URL = env.get("WEB_URL", 'http://localhost:8000')
...
EMAIL_PORT = to_int(env.get("EMAIL_PORT", "587"), 587)
EMAIL_HOST_PASSWORD = env.get("EMAIL_HOST_PASSWORD","blopper")
EMAIL_HOST_USER = env.get("EMAIL_HOST_USER","blopper")
...
TELEGRAM_KEY = env.get("TELEGRAM_KEY", "None")
